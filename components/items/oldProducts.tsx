...
export default function NewProduct({ product, viewMode = "grid" }: ProductProps) {
              ...
              <div className="flex flex-col h-full">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm text-gray-600">{product.reviews} ta sharh</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button disabled={!product.inStock} className="bg-green-600 hover:bg-green-700">
      ...
      <CardContent className="p-0">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            ...
            {!product.inStock && <Badge variant="secondary">Tugagan</Badge>}
          </div>
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button className="bg-green-600 hover:bg-green-700" disabled={!product.inStock}>
              Sotib oling
            </Button>
